...
*************************************/
local resultsfile `"Simulation study II\Results\ScenarioB_regress_`samplesize'obs_`priortxt'inf_uniform`uniform'_`numMCreps'reps_strengthUC`strength_UC'.dta"'
