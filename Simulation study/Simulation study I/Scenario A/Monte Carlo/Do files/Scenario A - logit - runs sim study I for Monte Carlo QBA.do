...
if `priorlevel'==2 {
	...
	local priortxt "medium"		// INFORMATIVE PRIOR; 95% OF DRAWN VALUES WITHIN 30% OF TRUTH
	...
	local priortxt "most"	   // VERY INFORMATIVE PRIOR; 95% OF DRAWN VALUES WITHIN 10% OF TRUTH	
...
*************************************/
local resultsfile ///
`"Simulation study I\Scenario A\Monte Carlo\Results\ScenarioA_logit_`samplesize'obs_`priortxt'inf_uniform`uniform'_`numMCreps'reps_strengthUC1.dta"'
